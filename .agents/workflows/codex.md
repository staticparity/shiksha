---
description: OpenAI Codex CLI wrapper - three modes. Code review: independent diff review via codex review with pass/fail gate. Challenge: adversarial mode that tries to break your code. Consul
---

<!-- Ported from gstack skill: codex -->
