---
description: Designers eye QA: finds visual inconsistency, spacing issues, hierarchy problems, AI slop patterns, and slow interactions - then fixes them. Iteratively fixes issues in source cod
---

<!-- Ported from gstack skill: design-review -->
