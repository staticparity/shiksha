---
description: Eng manager-mode plan review. Lock in the execution plan with architecture, data flow, edge cases, test coverage, and performance review. Use when asked to review the architecture, engineering review, or lock in the plan.
---

<!-- Ported from gstack skill: plan-eng-review -->
