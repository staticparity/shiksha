---
description: Report-only QA testing. Systematically tests a web application and produces a structured report with health score, screenshots, and repro steps - but never fixes anything. Use when
---

<!-- Ported from gstack skill: qa-only -->
