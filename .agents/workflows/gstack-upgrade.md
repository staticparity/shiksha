---
description: Upgrade gstack to the latest version. Detects global vs vendored install, runs the upgrade, and shows whats new. Use when asked to upgrade gstack, update gstack, or get latest ver
---

<!-- Ported from gstack skill: gstack-upgrade -->
