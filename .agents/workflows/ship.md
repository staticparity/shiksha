---
description: Ship workflow: detect + merge base branch, run tests, review diff, bump VERSION, update CHANGELOG, commit, push, create PR. Use when asked to ship, deploy, push to main, create a P
---

<!-- Ported from gstack skill: ship -->
