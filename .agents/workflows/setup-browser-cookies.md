---
description: Import cookies from your real Chromium browser into the headless browse session. Opens an interactive picker UI where you select which cookie domains to import. Use before QA testi
---

<!-- Ported from gstack skill: setup-browser-cookies -->
